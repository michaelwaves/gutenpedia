...
class ActivationTopkByTokenPostRequest(BaseModel):
    ...
    clear_cache: Optional[StrictBool] = Field(default=False, description="Clear GPU cache after processing to prevent memory accumulation")
    token_mask: Optional[List[StrictInt]] = Field(default=None, description="Optional mask for tokens (0=skip, 1=include). Must match token count if provided.")
    __properties: ClassVar[List[str]] = ["prompt", "model", "source", "top_k", "ignore_bos", "clear_cache", "token_mask"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clear_cache": obj.get("clear_cache", False),
            "token_mask": obj.get("token_mask")
        })
        return _obj
